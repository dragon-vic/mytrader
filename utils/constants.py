...
# 双向外部 JSON data client 默认值。
EXTERNAL_JSON_CLIENT_NAME = "EXTERNAL_JSON"
EXTERNAL_JSON_DEFAULT_HOST = "127.0.0.1"
EXTERNAL_JSON_DEFAULT_PORT = 9003
EXTERNAL_JSON_SEND_TOPIC = "external.json.send"
